...
- **Disappointment Criterion (Pre-Committed):** If control solves tasks in $\le 2$ turns without assistance, the model already possesses internalized parametric memory of the gotcha, rendering in-context injection redundant.
